...
function renderCurrentView() {
  const map = { dashboard: renderDashboard, agenda: renderAgenda, sales: renderSales, reception: renderReception, production: renderProduction, delivery: renderDelivery, commissions: renderCommissions, config: renderConfig };
